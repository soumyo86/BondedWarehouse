...
//get truckId and status for all documents
func (t *CBDoc) viewAllTruckDetails(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
...
func (t *CBDoc) Query(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
	...
	}else if function == "viewAllTruckDetails" { 
		t := CBDoc{}
		return t.viewAllTruckDetails(stub, args)
	}
